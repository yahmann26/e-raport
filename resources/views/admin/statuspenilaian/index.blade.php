                ...
                <table class="table table-bordered table-striped">
                  <thead class="bg-info">
                    <tr>
                      ...
                      <th colspan="3" class="text-center" style="width: 200px;">Status Penilaian</th>
                      <th colspan="2" class="text-center" style="width: 100px;">Status Nilai Raport</th>
                    </tr>
                    <tr>
                      <th class="text-center" style="width: 50px;">absen</th>
                      <th class="text-center" style="width: 50px;">setoran</th>
