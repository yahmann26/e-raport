                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data_anggota_kelas->sortBy('santri.nama_lengkap') as $anggota_kelas)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $anggota_kelas->santri->nisn }}</td>
                                                        ...
                                                        <div class="modal-dialog modal-xl">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">Nilai Akhir Semester santri
                                                                    </h5>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-6"><strong>:
                                                                                {{ $anggota_kelas->santri->nama_lengkap }}</strong>
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-10"><strong>:
                                                                                {{ $anggota_kelas->santri->nis }} /
                                                                                {{ $anggota_kelas->santri->nisn }}</strong>
                                                                        </div>
                                                                    </div>
                                                                    <!-- /. Header Info-->
                                                                                ...
                                                                                <table class="table table-bordered">
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        @foreach ($anggota_kelas->data_nilai_mapel_wajib->sortBy('pembelajaran.mapel.mapping_mapel.nomor_urut') as $nilai_mapel_wajib)
                                                                                            <?php
                                                                                            $no_a++;
                                                                                            $nama_mapel = $nilai_mapel_wajib->pembelajaran->mapel->nama_mapel;
                                                                                            $rata = collect($rata_rata_per_kelompok['wajib'])->firstWhere('nama_mapel', $nama_mapel); ?>
                                                                                            <tr class="bg-white">
                                                                                                <td
                                                                                                    class="text-center">
                                                                                                    {{ $no_a }}
                                                                                                ...
                                                                                                <td
                                                                                                    class="text-center">
                                                                                                    {{ $nilai_mapel_wajib->nilai_akhir }}
                                                                                                </td>
                                                                                                <td>{{ terbilang($nilai_mapel_wajib->nilai_akhir) }}
                                                                                                </td>
                                                                                                <td
                                                                                                    class="text-center">
                                                                                                    {{ $rata['rata_nilai'] ?? '-' }}
                                                                                                </td>
                                                                                                <td>{{ isset($rata['rata_nilai']) ? terbilang($rata['rata_nilai']) : '-' }}
                                                                                                </td>
                                                                                            </tr>
                                                                                        @endforeach
                                                                                        ...
                                                                                        @foreach ($anggota_kelas->data_nilai_mapel_pilihan->sortBy('pembelajaran.mapel.mapping_mapel.nomor_urut') as $nilai_mapel_pilihan)
                                                                                            ...
                                                                                            <tr class="bg-white">
                                                                                                ...
                                                                                                <td>{{ $nilai_mapel_pilihan->pembelajaran->mapel->nama_mapel }}
                                                                                                </td>
                                                                                                <td
                                                                                                    class="text-center">
                                                                                                    {{ $nilai_mapel_pilihan->kkm }}
                                                                                                </td>
                                                                                                <td
                                                                                                    class="text-center">
                                                                                                    {{ $nilai_mapel_pilihan->nilai_akhir }}
                                                                                                </td>
                                                                                                <td>{{ terbilang($nilai_mapel_pilihan->nilai_akhir) }}
                                                                                                </td>
                                                                                                <td
                                                                                                    class="text-center">
                                                                                                    {{ $nilai_mapel_pilihan->predikat }}
                                                                                                </td>
                                                                                            </tr>
                                                                                        @endforeach
                                                                                        ...
                                                                                        @foreach ($anggota_kelas->data_nilai_mapel_muatan_lokal->sortBy('pembelajaran.mapel.mapping_mapel.nomor_urut') as $nilai_muatan_lokal)
                                                                                            ...
                                                                                            <tr class="bg-white">
                                                                                                ...
                                                                                                <td>{{ $nilai_muatan_lokal->pembelajaran->mapel->nama_mapel }}
                                                                                                </td>
                                                                                                <td
                                                                                                    class="text-center">
                                                                                                    {{ $nilai_muatan_lokal->kkm }}
                                                                                                </td>
                                                                                                <td
                                                                                                    class="text-center">
                                                                                                    {{ $nilai_muatan_lokal->nilai_akhir }}
                                                                                                </td>
                                                                                                <td>{{ terbilang($nilai_muatan_lokal->nilai_akhir) }}
                                                                                                </td>
                                                                                                <td
                                                                                                    class="text-center">
                                                                                                    {{ $nilai_muatan_lokal->predikat }}
                                                                                                </td>
                                                                                            </tr>
                                                                                        @endforeach
