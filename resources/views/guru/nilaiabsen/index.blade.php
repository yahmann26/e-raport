            ...
            <div class="modal fade" id="modal-download">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  {{-- <form name="contact-form" action="{{ route('nilaiabsen.format_import') }}" method="GET">
                    @csrf
            ...
            <div class="modal fade" id="modal-import">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  {{-- <form name="contact-form" action="{{ route('nilaiabsen.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                      <div class="callout callout-info">
                        <h5>Perhatian</h5>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <form action="{{ route('nilaiabsen.create') }}" method="GET">
                          @csrf
