                        ...
                        <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header bg-success">
                                    <h3 class="card-title"><i class="fas fa-file-invoice"></i> Nilai Raport Terkirim
                                    </h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                                <?php $no = 0; ?>
                                                @foreach ($data_nilai_terkirim->sortBy('anggota_kelas.santri.nama_lengkap') as $nilai_terkirim)
                                                    <?php $no++; ?>
                                                    <tr>
                                                        <td class="text-center" style="width: 5%;">{{ $no }}
                                                        </td>

                                                        <td>{{ $nilai_terkirim->anggota_kelas->santri->nis }}
                                                        </td>
                                                        <td>{{ $nilai_terkirim->anggota_kelas->santri->nama_lengkap }}
                                                        </td>
