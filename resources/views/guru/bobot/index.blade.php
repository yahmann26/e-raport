              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  <thead class="bg-success">
                    ...
                    <tr>
                      <th class="text-center" style="width: 100px;">ABSEN</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      @if(is_null($bobot_nilai->bobot_setoran))
                      ...
                      @else
                      <td class="text-center">
                        <span class="badge badge-success">{{$bobot_nilai->bobot_absen}}</span>
                      </td>
                      <td class="text-center">
                        <span class="badge badge-success">{{$bobot_nilai->bobot_setoran}}</span>
                      </td>
                      <td class="text-center">
                                ...
                                <div class="row">
                                  <div class="col-sm-3">
                                    <div class="form-group">
                                      <label>Absen</label>
                                      <input type="number" class="form-control" name="bobot_absen" value="1">
                                    </div>
                                  </div>
                                  <div class="col-sm-3">
                                    <div class="form-group">
                                      <label>Setoran</label>
                                      <input type="number" class="form-control" name="bobot_setoran" value="2">
                                    </div>
                                  </div>
                                  <div class="col-sm-3">
                                    <div class="form-group">
                              ...
                              <div class="modal-body">
                                <div class="row">
                                  <div class="col-sm-3">
                                    <div class="form-group">
                                      <label>Absen</label>
                                      <input type="number" class="form-control" name="bobot_absen" value="{{$bobot_nilai->bobot_absen}}">
                                    </div>
                                  </div>
                                  <div class="col-sm-3">
                                    <div class="form-group">
                                      <label>Setoran</label>
                                      <input type="number" class="form-control" name="bobot_setoran" value="{{$bobot_nilai->bobot_setoran}}">
                                    </div>
                                  </div>
                                  <div class="col-sm-3">
                                    <div class="form-group">
