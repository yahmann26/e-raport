...
class SantriController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($jumlah_kelas == 0) {
            ...
            $data_kelas_all = Kelas::where('tapel_id', $tapel->id)
                ->orderBy('tingkatan_kelas', 'ASC')->get();

            // Ambil semua santri dan anggota_kelas + kelas
            $data_santri = Santri::with(['anggota_kelas.kelas'])->orderBy('nis', 'ASC')->get();
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'nomor_hp' => 'nullable|numeric|digits_between:11,13|unique:santri',
